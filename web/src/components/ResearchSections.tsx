...
const pipeline = [
  ...
  'Independent PD phenotype validation',
]
    ...
    <main className="research-content">
      ...
      <section id="data" className="data-methods-grid">
        ...
        <div id="methods">
          ...
          <h3>Limitations</h3>
          <p>The adjacency graph encodes voxel contact, not neural connectivity. Four isolated small brainstem parcels are retained but less spatially constrained. Singleton MSR is conservative, the AHBA has six unevenly sampled donors, the atlas crosswalk includes composite mappings, and ENIGMA structural MRI is a cross-sectional anatomical phenotype rather than direct histopathology. The maps do not establish pathology, causality, disease origin, temporal direction, or individual prediction.</p>
